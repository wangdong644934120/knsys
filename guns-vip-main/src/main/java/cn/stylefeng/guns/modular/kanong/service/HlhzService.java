...
import cn.stylefeng.guns.modular.kanong.mapper.HlhzMapper;
 ...
 */
@Service
public class HlhzService extends ServiceImpl<HlhzMapper, Ddkh> {
    ...
    public DdkhResult getHlhzById(DdkhParam param){
        List<DdkhResult> list=this.baseMapper.getHlhzById(param);
        if(list!=null && !list.isEmpty()){
            return list.get(0);
        }else{
            return null;
