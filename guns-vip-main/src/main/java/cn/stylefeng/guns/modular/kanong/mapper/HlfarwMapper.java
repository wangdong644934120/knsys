 ...
 * @since 2020-03-16
 */
public interface HlfarwMapper extends BaseMapper<Ddkh> {
    ...
    List<DdkhResult> getHlfarwById(@Param("paramCondition") DdkhParam paramCondition);

    public int updateRW(@Param("paramCondition") DdkhParam paramCondition);

    public int updateXGT(@Param("paramCondition") DdkhParam paramCondition);

    public int updateHTQD(@Param("paramCondition") DdkhParam paramCondition);
