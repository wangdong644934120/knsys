...
import cn.stylefeng.guns.modular.kanong.mapper.DjhyrwMapper;
 ...
 */
@Service
public class DjhyrwService extends ServiceImpl<DjhyrwMapper, Ddkh> {
    ...
    public DdkhResult getDjhyrwById(DdkhParam param){
        List<DdkhResult> list=this.baseMapper.getDjhyrwById(param);
        if(list!=null && !list.isEmpty()){
            return list.get(0);
        }else{
            return null;
