 ...
 * @since 2020-03-16
 */
public interface FKXMMapper extends BaseMapper<Ddkh> {
    ...
    List<DdkhResult> getFKXMById(@Param("paramCondition") DdkhParam paramCondition);

    public int updateFKXM(@Param("paramCondition") DdkhParam paramCondition);
