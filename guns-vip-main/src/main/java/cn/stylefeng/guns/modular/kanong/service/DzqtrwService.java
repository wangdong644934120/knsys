...
import cn.stylefeng.guns.modular.kanong.mapper.DzqtrwMapper;
 ...
 */
@Service
public class DzqtrwService extends ServiceImpl<DzqtrwMapper, Ddkh> {
    ...
    public DdkhResult getDzqtrwById(DdkhParam param){
        List<DdkhResult> list=this.baseMapper.getDzqtrwById(param);
        if(list!=null && !list.isEmpty()){
            return list.get(0);
        }else{
            return null;
