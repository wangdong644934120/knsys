...
import cn.stylefeng.guns.modular.kanong.mapper.WlcgrwMapper;
 ...
 */
@Service
public class WlcgrwService extends ServiceImpl<WlcgrwMapper, Ddkh> {
    ...
    public DdkhResult getWlcgrwById(DdkhParam param){
        List<DdkhResult> list=this.baseMapper.getWlcgrwById(param);
        if(list!=null && !list.isEmpty()){
            return list.get(0);
        }else{
            return null;
