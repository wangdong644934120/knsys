...
import cn.stylefeng.guns.modular.kanong.mapper.HlsxsMapper;
import cn.stylefeng.guns.modular.kanong.model.params.DdkhParam;
import cn.stylefeng.guns.modular.kanong.model.params.HlsxsParam;
import cn.stylefeng.guns.modular.kanong.model.result.DdkhResult;
import cn.stylefeng.guns.modular.kanong.model.result.HlsxsResult;
 ...
 */
@Service
public class HlsxsService extends ServiceImpl<HlsxsMapper, Ddkh> {
    ...
    public DdkhResult getHlsxsById(DdkhParam param){
        List<DdkhResult> list=this.baseMapper.getHlsxsById(param);
        if(list!=null && !list.isEmpty()){
            return list.get(0);
        }else{
            return null;
